        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
            <div class="container">
                <div class="container-fluid">
                    <a class="navbar-brand pt-3" href="{{ route('pemas.index') }}">
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        @if (Auth::guard('masyarakat')->check())
                            <ul class="navbar-nav text-center ml-auto">
                                <li class="nav-item">
                                    <a class="nav-link ml-3 text-white" href="{{ route('pemas.laporan') }}">Laporan</a>
                                </li>
                                <li class="nav-item">
    ...
    <div class="row mt-5">
        <div class="col-lg-8">
            <a class="d-inline tab {{ $siapa != 'me' ? 'tab-active' : '' }} mr-4"
                href="{{ route('pemas.laporan') }}">
                Semua
            </a>
            <a class="d-inline tab {{ $siapa == 'me' ? 'tab-active' : '' }}"
                href="{{ route('pemas.laporan', 'me') }}">
                Laporan Saya
            </a>
            <hr>
        </div>
                ...
                <div class="laporan-top">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            ...
                            @if ($v->akses == '0')
                                <p><strong>Belum Dikonfirmasi</strong></p>
